  ...
  <style>
    * {
    ...
    #page1 {
      ...
      min-height: 100vh;
      background: 
        linear-gradient(rgba(255, 240, 245, 0.3), rgba(255, 240, 245, 0.3)),
        url('https://i.ibb.co/M57TNDnR/3073960cd67699563a673dcf31b91d56.jpg');
    ...
    #page2 {
      ...
      min-height: 100vh;
      background: 
        linear-gradient(rgba(30, 10, 18, 0.2), rgba(30, 10, 18, 0.2)),
        url('https://i.ibb.co/fdP17fJ1/f97959d5e6dc56db2fcef3898e0176ed.jpg');
      background-size: cover;
      background-position: center;
      background-repeat: no-repeat;
      align-items: center;
...
<body>
  ...
  <div id="page1">
    <div class="entrance-card">
      <h1 class="greeting">Happy Birthday, Chloe</h1>
  ...
  <div id="page2">
    ...
    <audio id="bgMusic" autoplay loop>
      <source src="https://audio.jukehost.co.uk/019f7da7-888a-7302-87e7-a78510d6812d" type="audio/mpeg">
